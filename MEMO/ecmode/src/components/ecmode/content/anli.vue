  ...
  <transition name="el-fade-in-linear">
    ...
    <div class="panel" style="padding:30px">
      ...
      <el-button-group>
        ...
        <el-button type="primary" plain @click="addVisible = true">添加评价</el-button>
      </el-button-group>
      ...
      <el-dialog title="新增评价" :visible.sync="addVisible"  center width="30%">
        <span>标题</span><br>
      ...
      <el-dialog title="修改评价" :visible.sync="updateVisible"  center width="30%">
        <span>标题</span><br>
        <el-input  v-model="addData.title"></el-input>
        <el-upload class="upload-demo" :data="{label:'image'}"  drag action="http://tzhop.free.ngrok.cc/" multiple :http-request="fileUpload">
          <i v-if="addData.image == ''" class="el-icon-upload"></i>
