  ...
  <div>
    <div class="animated fadeInUp panel">
      <div style="padding-top:15px;font-size:18px">
        <span><span style="cursor:pointer" @click="goback">类目管理</span> / <span style="font-size:14px">{{title}}</span> </span>
      </div>
      <div>
        <span style="color:#888888">此页为二级类目编辑。</span>
      </div>
      <hr>
      ...
      <el-table ref="multipleTable" :data="list" border tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="categoryTwoName" label="类目名称" sortable>
        </el-table-column>
        ...
        <el-table-column fixed="right" label="操作" >
          <template scope="scope">
            ...
            <el-dropdown style="margin-left:5px" trigger="click" :hide-on-click="false" slot="dropdown">
              <el-button type="text" size="small" class="el-dropdown-link">
                更多
              </el-button>
              <el-dropdown-menu  >
                <el-dropdown-item>
                  <el-button style="width:100%;height:100%"  type="text" size="small">上移</el-button>
                </el-dropdown-item>
                <el-dropdown-item>
                  <el-button  style="width:100%;height:100%"  type="text" size="small">下移</el-button>
                </el-dropdown-item>
                <el-dropdown-item>
                  <el-button style="width:100%;height:100%"  type="text" size="small" >置顶</el-button>
                </el-dropdown-item>
                <el-dropdown-item>
                  <el-button style="width:100%;height:100%"  type="text" size="small" @click="deleteSimpleRow(scope.row.categoryTwoId)">删除</el-button>
                </el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </template>
      ...
      <el-form :label-position="'left'" :model="company" :rules="companyRules" ref="company" label-width="0" class="demo-ruleForm">
        <el-row :gutter="30">
          <el-col :span="8">
            ...
            <el-form-item>
              <el-input v-model="company.categoryTwoName" placeholder="分类名称"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <span style="line-height:30px">
...
export default {
  ...
  mounted: function () {
    this.company.categoryOneId = this.$route.params.row.categoryOneId;
