  ...
  <div>
    <div class="animated fadeInUp panel">
      ...
      <div style="float:right;">
        ...
        <el-select v-model="select2" placeholder="二级类目" v-if="categoryTwo.length > 0" @change="categoryTwoChange">
          ...
          <template scope="scope">
            ...
            <el-dropdown style="margin-left:5px">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item>
                  <el-button style="height:100%;width:100%" type="text" size="small" @click="luntype=2,id = scope.row.commodityId,addDia = true">添加到个人品牌包装页轮播图</el-button>
                </el-dropdown-item>
                <el-dropdown-item>
                  <el-button style="height:100%;width:100%" type="text" size="small" @click="luntype=3,id = scope.row.commodityId,addDia = true">添加到私人订制页轮播图</el-button>
                </el-dropdown-item>
                <el-dropdown-item>
...
export default {
  data() {
    return {
      ...
      fatype:2,
      fapath:'/pages/mall/productMain/productMain?id=',
      id:0,
      isActivity:true,
      addDialog:false,
      select1: '',
      ...
      $.ajax({
        ...
        success: function(res) {
          if (res.code == 1000) {
            ...
            that.activity.lunpath = res.result;
            that.$message({
              type: 'success',
              message: '上传成功'
            });
