...
<transition name="el-fade-in-linear">
  <div class="panel">
    <div style="padding:30px">
      ...
      <div class="font-md color-def" style="margin-top:10px">商品轮播图，为用户更好的体验，每件商品最多放5张图片。</div>
      ...
      <div style="margin-top:20px">
        <el-button-group class="pull-left">
          ...
          <el-button type="primary" icon="el-icon-plus" @click="dialogVisible = true" plain>新增轮播图</el-button>
        </el-button-group>
      ...
      <el-table  ref="multipleTable" :data="list" tooltip-effect="dark" style="width: 100%;margin-top:20px" @selection-change="handleSelectionChange">
        ...
        <el-table-column fixed="right" label="操作" >
          <template slot-scope="scope">
            <el-button-group >
              <el-button type="default" size="small" @click="updateSimpleRow(scope.row,scope.$index)">修改</el-button>
              <el-button type="danger" size="small" @click="deleteSimpleRow(scope.row.carouselId)">删除</el-button>
            </el-button-group>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="图片信息" :visible.sync="dialogVisible" >
